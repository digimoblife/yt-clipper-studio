...
🚀 Fitur Utama
1. YouTube Downloader & Trimmer: Mengunduh video berdasarkan rentang waktu (start & end) yang spesifik untuk menghindari pemborosan kuota dan ruang penyimpanan.
2. Dual-Mode Output: Mendukung pengunduhan langsung dalam format original (Landscape) atau otomatis di-crop menjadi format Portrait.
3. Manual Video Converter: Fitur untuk mengunggah video lokal dari folder mana pun di Mac dan mengubahnya menjadi format portrait.
4. Anti-Double Click Protection: Sistem pengunci tombol untuk mencegah beban CPU berlebih pada MacBook Air saat proses render video berlangsung.
